"use strict";
(self["webpackChunkgranit_strapi"] = self["webpackChunkgranit_strapi"] || []).push([[5895],{
...
const FromComputerForm = ({ setLocalImage, goTo, next, onClose }) => {
  ...
  }, { size: SIZE, dimension: DIMENSION })))), /* @__PURE__ */ react.createElement(Field.FieldError, null)))))), /* @__PURE__ */ react.createElement(ModalLayout.ModalFooter, {
...
const FromUrlForm = ({ goTo, next, onClose, setLocalImage }) => {
  ...
  const handleSubmit = (e) => FromUrlForm_async(void 0, null, function* () {
    e.preventDefault();
    try {
...
const Form = (0,react.forwardRef)(({ projectSettingsStored }, ref) => {
  ...
  const [{ menuLogo }, dispatch] = (0,react.useReducer)(Form_reducer, Form_reducer_initialState, () => Form_init(Form_reducer_initialState, projectSettingsStored));
...
const prefixAllUrls = (data) => transform_default()(data, (result, value, key) => {
  if (value && value.url) {
