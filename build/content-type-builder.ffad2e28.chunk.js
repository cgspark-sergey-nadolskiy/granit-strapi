(self["webpackChunkgranit_strapi"] = self["webpackChunkgranit_strapi"] || []).push([[8880],{
...
const FormModal = () => {
  ...
  const checkFormValidity = () => __async(void 0, null, function* () {
    let schema;
  ...
  const handleSubmit = (_0, ..._1) => __async(void 0, [_0, ..._1], function* (e, shouldContinue = isCreating) {
    e.preventDefault();
    try {
