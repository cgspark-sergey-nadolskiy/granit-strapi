(self["webpackChunkgranit_strapi"] = self["webpackChunkgranit_strapi"] || []).push([[483],{
...
const AuthenticatedApp = (0,react.lazy)(() => Promise.all(/* import() | Admin-authenticatedApp */[__webpack_require__.e(7814), __webpack_require__.e(189), __webpack_require__.e(801)]).then(__webpack_require__.bind(__webpack_require__, 63339)));
function App() {
  const toggleNotification = (0,build.useNotification)();
...
class StrapiApp {
  constructor({ adminConfig, appPlugins, library, middlewares, reducers }) {
    ...
    __publicField(this, "addCorePluginMenuLink", (link) => {
      ...
      browser_default()(typeof link.to === "string", `Expected link.to to be a string instead received ${typeof link.to}`);
      browser_default()(["/plugins/content-type-builder", "/plugins/upload"].includes(link.to), "This method is not available for your plugin");
      browser_default()(((_a = link.intlLabel) == null ? void 0 : _a.id) && ((_b = link.intlLabel) == null ? void 0 : _b.defaultMessage), `link.intlLabel.id & link.intlLabel.defaultMessage for ${stringifiedLink}`);
      this.menu.push(link);
    });
    ...
    __publicField(this, "addMenuLink", (link) => {
      ...
      browser_default()(typeof link.to === "string", `Expected link.to to be a string instead received ${typeof link.to}`);
      browser_default()(((_a = link.intlLabel) == null ? void 0 : _a.id) && ((_b = link.intlLabel) == null ? void 0 : _b.defaultMessage), `link.intlLabel.id & link.intlLabel.defaultMessage for ${stringifiedLink}`);
      browser_default()(link.Component && typeof link.Component === "function", `link.Component should be a valid React Component`);
      browser_default()(link.icon && typeof link.icon === "function", `link.Icon should be a valid React Component`);
      this.menu.push(link);
    });
    ...
    __publicField(this, "createSettingSection", (section, links) => {
      ...
      browser_default()(((_a = section.intlLabel) == null ? void 0 : _a.id) && ((_b = section.intlLabel) == null ? void 0 : _b.defaultMessage), "section.intlLabel should be defined");
      browser_default()(Array.isArray(links), "TypeError expected links to be an array");
    ...
    __publicField(this, "injectContentManagerComponent", (containerName, blockName, component) => {
      var _a;
      browser_default()((_a = this.admin.injectionZones.contentManager[containerName]) == null ? void 0 : _a[blockName], `The ${containerName} ${blockName} zone is not defined in the content manager`);
    ...
    __publicField(this, "injectAdminComponent", (containerName, blockName, component) => {
      var _a;
      browser_default()((_a = this.admin.injectionZones.admin[containerName]) == null ? void 0 : _a[blockName], `The ${containerName} ${blockName} zone is not defined in the admin`);
      browser_default()(component, "A Component must be provided");
      this.admin.injectionZones.admin[containerName][blockName].push(component);
    });
    __publicField(this, "registerHook", (name, fn) => {
      browser_default()(this.hooksDict[name], `The hook ${name} is not defined. You are trying to register a hook that does not exist in the application.`);
...
/* harmony import */ var _layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(83137);
/* harmony import */ var _components_UnauthenticatedLogo__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(87173);
/* harmony import */ var _FieldActionWrapper__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(11145);
