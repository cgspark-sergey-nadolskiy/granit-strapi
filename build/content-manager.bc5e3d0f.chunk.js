(self["webpackChunkgranit_strapi"] = self["webpackChunkgranit_strapi"] || []).push([[994],{
...
const useFetchContentTypeLayout = (contentTypeUID) => {
  ...
  const getData = (0,react.useCallback)((uid, source) => __async(void 0, null, function* () {
    if (layouts[uid]) {
  ...
  const updateLayout = (0,react.useCallback)((data) => {
    dispatch({
      type: "UPDATE_LAYOUT",
...
const getSelectStyles = (theme) => {
  return {
    ...
    input: (base) => getSelectStyles_spreadProps(getSelectStyles_spreadValues({}, base), { margin: 0, padding: 0, color: theme.colors.neutral800 }),
    menu: (base) => {
      return getSelectStyles_spreadProps(getSelectStyles_spreadValues({}, base), {
        width: "100%",
...
const CollectionTypeFormWrapper = ({ allLayoutData, children, slug, id, origin }) => {
  ...
  const onDelete = (0,react.useCallback)((trackerProperty) => CollectionTypeFormWrapper_async(void 0, null, function* () {
    try {
  ...
  const onPost = (0,react.useCallback)((body, trackerProperty) => CollectionTypeFormWrapper_async(void 0, null, function* () {
  ...
  const onPut = (0,react.useCallback)((body, trackerProperty) => CollectionTypeFormWrapper_async(void 0, null, function* () {
...
const EditViewDataManagerProvider = ({
  ...
  const checkFormErrors = (0,react.useCallback)((..._0) => EditViewDataManagerProvider_async(void 0, [..._0], function* (dataToSet = {}) {
    let errors = {};
  ...
  const handleChange = (0,react.useCallback)(({ target: { name, value, type } }, shouldSetInitialValue = false) => {
    ...
    if (["text", "textarea", "string", "email", "uid", "select", "select-one", "number"].includes(type) && !value) {
      inputValue = null;
    }
  ...
  const handleSubmit = (0,react.useCallback)((e) => EditViewDataManagerProvider_async(void 0, null, function* () {
    e.preventDefault();
    let errors = {};
    try {
...
const SingleTypeFormWrapper = ({ allLayoutData, children, slug }) => {
  ...
  const onDelete = (0,react.useCallback)((trackerProperty) => SingleTypeFormWrapper_async(void 0, null, function* () {
    try {
      trackUsageRef.current("willDeleteEntry", trackerProperty);
  ...
  const onPost = (0,react.useCallback)((body, trackerProperty) => SingleTypeFormWrapper_async(void 0, null, function* () {
  ...
  const onPut = (0,react.useCallback)((body, trackerProperty) => SingleTypeFormWrapper_async(void 0, null, function* () {
    const endPoint = SingleTypeFormWrapper_utils_getRequestUrl(`${slug}${rawQuery}`);
    try {
      trackUsageRef.current("willEditEntry", trackerProperty);
      dispatch(setStatus("submit-pending"));
...
const LeftMenu = () => {
  ...
  const { collectionTypeLinks, singleTypeLinks } = (0,lib.useSelector)((state) => modelLinksSelector(state), lib.shallowEqual);
