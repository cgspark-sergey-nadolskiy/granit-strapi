"use strict";
(self["webpackChunkgranit_strapi"] = self["webpackChunkgranit_strapi"] || []).push([[8056],{
...
const ApiTokenListView = () => {
  ...
  const { data: apiTokens, status, isFetching } = (0,lib.useQuery)(["api-tokens"], () => __async(void 0, null, function* () {
  ...
  const deleteMutation = (0,lib.useMutation)((id) => __async(void 0, null, function* () {
