(self["webpackChunkgranit_strapi"] = self["webpackChunkgranit_strapi"] || []).push([[8853],{
...
const usePlugins = (shouldFetchData = true) => {
  ...
  const fetchPlugins = (0,react.useCallback)(() => usePlugins_async(void 0, null, function* () {
    try {
      ...
      const [{ permissions: permissions2 }, { routes: routes2 }] = yield Promise.all([`/${src_pluginId/* default */.Z}/permissions`, `/${src_pluginId/* default */.Z}/routes`].map((endpoint) => usePlugins_async(void 0, null, function* () {
...
instance.interceptors.request.use((config) => __async(void 0, null, function* () {
  config.headers = {
